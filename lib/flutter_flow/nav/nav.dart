...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const ForumWidget() : const LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Forum',
          path: '/forum',
          builder: (context, params) => const ForumWidget(),
        ),
        FFRoute(
          name: 'market',
          path: '/market',
        ...
        FFRoute(
          name: 'EventsAdmin',
          path: '/eventsAdmin',
          builder: (context, params) => const EventsAdminWidget(),
        ),
        FFRoute(
          name: 'EventDetails',
          path: '/eventDetails',
        ...
        FFRoute(
          name: 'paimentSuccess',
          path: '/paimentSuccess',
          builder: (context, params) => PaimentSuccessWidget(
        ...
        FFRoute(
          name: 'PostsAdmin',
          path: '/postsAdmin',
          builder: (context, params) => const PostsAdminWidget(),
        ),
        FFRoute(
          name: 'postDetailsAdmin',
          path: '/postDetailsAdmin',
          builder: (context, params) => PostDetailsAdminWidget(
            post: params.getParam(
              'post',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          builder: (context, params) => EventDetailsAdminWidget(
            event: params.getParam(
              'event',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'ProductsUser',
          path: '/productsUser',
          builder: (context, params) => const ProductsUserWidget(),
        ),
        FFRoute(
          name: 'PostHistory',
          path: '/postHistory',
          builder: (context, params) => const PostHistoryWidget(),
        ),
        FFRoute(
          name: 'MyTickets',
          path: '/myTickets',
