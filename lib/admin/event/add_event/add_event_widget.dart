import '/admin/event/add_event_step2/add_event_step2_widget.dart';
                            ...
                            if (_model.datePicked == null) {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: const Text('Date required'),
                                    content: const Text(
                                        'Please Make sure to pick a date for the event'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
