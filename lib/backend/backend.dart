...
import 'schema/event_reservation_record.dart';
...
export 'schema/event_reservation_record.dart';
...
/// Functions to query EventReservationRecords (as a Stream and as a Future).
Future<int> queryEventReservationRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EventReservationRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EventReservationRecord>> queryEventReservationRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EventReservationRecord.collection,
      EventReservationRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EventReservationRecord>> queryEventReservationRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
