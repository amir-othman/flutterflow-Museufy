...
import '/user/posts/update_post/update_post_widget.dart';
import 'package:flutter/material.dart';
import 'post_history_model.dart';
export 'post_history_model.dart';

class PostHistoryWidget extends StatefulWidget {
  const PostHistoryWidget({super.key});

  @override
  State<PostHistoryWidget> createState() => _PostHistoryWidgetState();
}

class _PostHistoryWidgetState extends State<PostHistoryWidget> {
  late PostHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostHistoryModel());
  }
