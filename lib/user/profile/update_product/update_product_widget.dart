      ...
      child: Container(
        ...
        child: StreamBuilder<ProductRecord>(
          ...
          builder: (context, snapshot) {
            ...
            final formProductRecord = snapshot.data!;
                              ...
                              Expanded(
                                child: TextFormField(
                                  controller: _model.nameTextController2 ??=
                                      TextEditingController(
                                    text: formProductRecord.description,
                                  ),
                              ...
                              Expanded(
                                child: TextFormField(
                                  controller: _model.descTextController ??=
                                      TextEditingController(
                                    text: formProductRecord.price.toString(),
                                  ),
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: AlertWidget(
                                        ...
                                        alert:
                                            'Your art is Up to date now   ..',
                                        action: () async {
                                          context.pushNamed('ProductsUser');
                                        },
                                      ),
                                    );
                                  },
