...
import '/user/market/create_product/create_product_widget.dart';
          ...
          child: Stack(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: StreamBuilder<List<ProductRecord>>(
                              stream: queryProductRecord(
                                queryBuilder: (productRecord) => productRecord
                                    .orderBy('nbrLikes', descending: true),
                                singleRecord: true,
                              ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            containerProductRecord!.picture,
                                            width: double.infinity,
                                            height: 200.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 5.0, 0.0, 0.0),
                                          child: Text(
                                            '${containerProductRecord.nbrLikes.toString()} Likes',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  fontFamily: 'Inter',
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Explore World Arts & Contact Artists',
                        style:
              ...
              Align(
                ...
                child: Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 20.0, 130.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: const CreateProductWidget(),
                            ),
                          );
                        },
