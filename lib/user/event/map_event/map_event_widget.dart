...
import 'map_event_model.dart';
export 'map_event_model.dart';
...
class MapEventWidget extends StatefulWidget {
  ...
  @override
  State<MapEventWidget> createState() => _MapEventWidgetState();
}

class _MapEventWidgetState extends State<MapEventWidget>
    with TickerProviderStateMixin {
  late MapEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapEventModel());
